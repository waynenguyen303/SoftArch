...
public class awaitCatalinaArch extends AbstractMyxSimpleBrick implements Istop,Iuserinput
{
	...
	private IawaitCatalinaImp _imp;

    public awaitCatalinaArch (){
    ...
    protected IawaitCatalinaImp getImplementation(){
        try{
			return new awaitCatalinaImp();    
        } catch (Exception e){
