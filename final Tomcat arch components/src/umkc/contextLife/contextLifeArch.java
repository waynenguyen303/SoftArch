...
public class contextLifeArch extends AbstractMyxSimpleBrick implements IcontextOut
{
    public static final IMyxName msg_IcontextOut = MyxUtils.createName("umkc.IcontextOut");


	private IcontextLifeImp _imp;

    public contextLifeArch (){
    ...
    protected IcontextLifeImp getImplementation(){
        try{
			return new contextLifeImp();    
        } catch (Exception e){
