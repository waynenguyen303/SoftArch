...
public class contextbindArch extends AbstractMyxSimpleBrick implements IcontextOut
{
    public static final IMyxName msg_IcontextOut = MyxUtils.createName("umkc.IcontextOut");


	private IcontextbindImp _imp;

    public contextbindArch (){
    ...
    protected IcontextbindImp getImplementation(){
        try{
			return new contextbindImp();    
        } catch (Exception e){
