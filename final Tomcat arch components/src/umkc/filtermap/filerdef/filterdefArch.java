...
public class filterdefArch extends AbstractMyxSimpleBrick implements IcontextOut
{
    public static final IMyxName msg_IcontextOut = MyxUtils.createName("umkc.IcontextOut");


	private IfilterdefImp _imp;

    public filterdefArch (){
    ...
    protected IfilterdefImp getImplementation(){
        try{
			return new filterdefImp();    
        } catch (Exception e){
