...
public class instancemanagerArch extends AbstractMyxSimpleBrick implements IcontextOut
{
    public static final IMyxName msg_IcontextOut = MyxUtils.createName("umkc.IcontextOut");


	private IinstancemanagerImp _imp;

    public instancemanagerArch (){
    ...
    protected IinstancemanagerImp getImplementation(){
        try{
			return new instancemanagerImp();    
        } catch (Exception e){
