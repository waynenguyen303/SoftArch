...
public class jarscannerArch extends AbstractMyxSimpleBrick implements IcontextOut
{
    public static final IMyxName msg_IcontextOut = MyxUtils.createName("umkc.IcontextOut");


	private IjarscannerImp _imp;

    public jarscannerArch (){
    ...
    protected IjarscannerImp getImplementation(){
        try{
			return new jarscannerImp();    
        } catch (Exception e){
