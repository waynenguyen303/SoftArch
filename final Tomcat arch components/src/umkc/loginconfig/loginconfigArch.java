...
public class loginconfigArch extends AbstractMyxSimpleBrick implements IcontextOut
{
    public static final IMyxName msg_IcontextOut = MyxUtils.createName("umkc.IcontextOut");


	private IloginconfigImp _imp;

    public loginconfigArch (){
    ...
    protected IloginconfigImp getImplementation(){
        try{
			return new loginconfigImp();    
        } catch (Exception e){
