...
public class servletcontextArch extends AbstractMyxSimpleBrick implements IcontextOut
{
    public static final IMyxName msg_IcontextOut = MyxUtils.createName("umkc.IcontextOut");


	private IservlercontextImp _imp;

    public servletcontextArch (){
    ...
    protected IservlercontextImp getImplementation(){
        try{
			return new servletcontextImp();    
        } catch (Exception e){
