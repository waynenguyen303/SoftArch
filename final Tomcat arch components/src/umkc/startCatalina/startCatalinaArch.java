...
public class startCatalinaArch extends AbstractMyxSimpleBrick implements Istop,Iuserinput
{
	...
	private IstartCatalinaImp _imp;

    public startCatalinaArch (){
    ...
    protected IstartCatalinaImp getImplementation(){
        try{
			return new startCatalinaImp();    
        } catch (Exception e){
