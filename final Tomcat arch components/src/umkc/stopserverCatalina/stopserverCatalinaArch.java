...
public class stopserverCatalinaArch extends AbstractMyxSimpleBrick implements Istop,Iuserinput
{
	...
	private IstopserverCatalinaImp _imp;

    public stopserverCatalinaArch (){
    ...
    protected IstopserverCatalinaImp getImplementation(){
        try{
			return new stopserverCatalinaImp();    
        } catch (Exception e){
